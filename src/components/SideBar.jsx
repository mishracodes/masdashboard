  ...
  return (
    <>
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-[#e6e7ee] border border-[#d1d9e6] shadow-[3px_3px_6px_#b8b9be,-3px_-3px_6px_#fff] dark:bg-gray-800">
          ...
          <ul className="space-y-2 font-medium">
            <li className=" hover:shadow-[inset_2px_2px_5px_#b8b9be,inset_-3px_-3px_7px_#fff,inset_2px_2px_5px_#b8b9be,inset_-3px_-3px_7px_#fff] rounded-xl">
              <Link
                to="/"
            ...
            <li className=" hover:shadow-[inset_2px_2px_5px_#b8b9be,inset_-3px_-3px_7px_#fff,inset_2px_2px_5px_#b8b9be,inset_-3px_-3px_7px_#fff] rounded-xl">
              ...
              >
                <svg
                  className="transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                  width="20"
                  height="20"
                  viewBox="0 0 70 50"
                  fill="none"
